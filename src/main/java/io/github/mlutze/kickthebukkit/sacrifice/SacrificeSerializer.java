...
public class SacrificeSerializer implements Serializer<Sacrifice> {
    ...
    public Map<String, Object> serialize(Sacrifice object) {
        return ImmutableMap.<String, Object>builder()
                ...
                .put("items", object.getItems().stream().map(ItemStack::serialize).collect(Collectors.toList()))
                .build();
    }
    ...
    public Sacrifice deserialize(Map<String, Object> serialization) {
        ...
        List<Map<String, Object>> itemSerializations = (List<Map<String, Object>>) serialization.get("items");
        List<ItemStack> items =
                itemSerializations.stream().map(itemStackSerializer::deserialize).collect(Collectors.toList());
